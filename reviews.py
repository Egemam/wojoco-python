    ...
    if not portfolios.portfolio_read(user):
        ...
        response = client.chat.completions.create(
            messages=[
                {
                    "role": "system",
                "content": f"Analyze the following content and decide if the place is matching with the person's portfolio. Adress to the person as you. Give your response with this format:\n[2 1 or 0 for yes maybe or no(should be related to the compatibility percentage), a percentage reflecting their compatibility(0-100),[reasons for yes with \"\"s seperated by commas],[resons for no with \"\"s seperated by commas]]\nfor example: \n[1, 60, [\"This place is suitable for you because you don't like staying late\", \"This place is suitable for you because you like the breaks\"], [\"This place is not suitable for you because you don't like low wages\", \"This place is not suitable for you because the temperatures are too cold for you\"]]\n\n Try to keep the amount of reasons for yes or no around the 2-5 range. DO NOT ADD ANYTHING ELSE BECAUSE THIS IS THE FORMAT AND GETTING OUT OF THE FORMAT WILL BREAK THE CODE\n\n I am repeating the format once again this is crucial for you to not break:\n[2 1 or 0 for yes maybe or no(should be related to the compatibility percentage), a percentage reflecting their compatibility,[reasons for yes with \"\"s seperated by commas],[resons for no with \"\"s seperated by commas]]\nANOTHER EXAMPLE:\n[1, 48,[\"The place is great for you because you don't like staying late\"], [\"The place is not great for you because you don't like low wages\"]]\n\nPlace: {place}\n\nPortfolio:\n\n{portfolio}\n\n{review_sum(place)}\n\n\n\nDO NOT FORGET NEVER BREAK THE FORMAT IT IS THERE FOR YOU TO OBEY. DO NOT FORGET THE QUOTATION MARKS"
                }
            ],
...
def review_sum(place):
    text = ""
    text = businesslist.find({"_id": place})[0].values()
    print(text)
    response = client.chat.completions.create(
        messages=[
            {
